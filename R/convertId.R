...
##' }
convertId<-function(x,dataset="hsapiens_gene_ensembl",filters="uniprot_swissprot",attributes =c(filters,"entrezgene"),genesKept=c('foldchange','first','random','var','abs'),keepNoId=T,keepMultipleId=F,verbose=F) {
#	if (! require("biomaRt")) {
